...
export type { IRegisterDiamond } from "./IRegisterDiamond";
export type { RegisterDiamond } from "./RegisterDiamond";
export type { RegisterDiamondReadable } from "./RegisterDiamondReadable";
export type { RegisterDiamondWritable } from "./RegisterDiamondWritable";
