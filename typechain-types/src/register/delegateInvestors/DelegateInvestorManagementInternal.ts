...
export interface DelegateInvestorManagementInternalInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BND_ROLE"
      | "CAK_ROLE"
...
export interface DelegateInvestorManagementInternal extends BaseContract {
  connect(runner?: ContractRunner | null): DelegateInvestorManagementInternal;
  waitForDeployment(): Promise<this>;

  interface: DelegateInvestorManagementInternalInterface;
