...
export interface RegisterDiamondReadableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "facetAddress"
      | "facetAddresses"
...
export interface RegisterDiamondReadable extends BaseContract {
  connect(runner?: ContractRunner | null): RegisterDiamondReadable;
  waitForDeployment(): Promise<this>;

  interface: RegisterDiamondReadableInterface;
