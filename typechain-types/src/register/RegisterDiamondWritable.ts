...
export interface RegisterDiamondWritableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BND_ROLE"
      | "CAK_ROLE"
...
export interface RegisterDiamondWritable extends BaseContract {
  connect(runner?: ContractRunner | null): RegisterDiamondWritable;
  waitForDeployment(): Promise<this>;

  interface: RegisterDiamondWritableInterface;
